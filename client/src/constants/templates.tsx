...
export const listCP = [
  ...
  },
  {
    ...
    nhomcp: "TV",
    tencp:
      "Tư vấn lập hồ sơ mời thầu, đánh giá hồ sơ dự thầu thi công xây dựng",
    key: "lhsmttc",
    template: BANGTRA5,
  },
  {
    ...
    nhomcp: "TV",
    tencp:
      "Tư vấn lập hồ sơ mời thầu, đánh giá hồ sơ dự thầu mua sắm vật tư, thiết bị",
    key: "lhsmttb",
    template: BANGTRA5,
  },
  {
...
export const tbBANGTONGHOPKHOILUONG = {
  ...
  colwidth: [30, 70, 70, 180, 50, 200, 70, 100],
  font: "Times New Roman",
  printArea: "A:H",
  pageSize: "a4",
  ...
  defaultConditionalFormat: [
    ...
    // },
    {
      ...
      border: true,
      formula:
        '=IF(OR(INDIRECT("RC[0]",0)="HM", INDIRECT("RC[-1]",0)="HM", INDIRECT("RC[-2]",0)="HM", INDIRECT("RC[-3]",0)="HM", INDIRECT("RC[-4]",0)="HM", INDIRECT("RC[-5]",0)="HM", INDIRECT("RC[-6]",0)="HM", INDIRECT("RC[-7]",0)="HM", INDIRECT("RC[-8]",0)="HM", INDIRECT("RC[-9]",0)="HM"),TRUE)',
    },
    {
      address: "A:H",
      color: null,
      ...
      border: true,
      formula:
        '=IF(OR(INDIRECT("RC[0]",0)="#", INDIRECT("RC[-1]",0)="#", INDIRECT("RC[-2]",0)="#", INDIRECT("RC[-3]",0)="#", INDIRECT("RC[-4]",0)="#", INDIRECT("RC[-5]",0)="#", INDIRECT("RC[-6]",0)="#", INDIRECT("RC[-7]",0)="#", INDIRECT("RC[-8]",0)="#", INDIRECT("RC[-9]",0)="#"),TRUE)',
    },
    {
      address: "A:H",
      color: null,
    ...
    },
    {
      ...
      border: true,
			...
			vCenter: true,
      formula:
        '=IF(OR(ISNUMBER(INDIRECT("RC[0]",0)), ISNUMBER(INDIRECT("RC[-1]",0)), ISNUMBER(INDIRECT("RC[-2]",0)), ISNUMBER(INDIRECT("RC[-3]",0)), ISNUMBER(INDIRECT("RC[-4]",0)), ISNUMBER(INDIRECT("RC[-5]",0)), ISNUMBER(INDIRECT("RC[-6]",0)), ISNUMBER(INDIRECT("RC[-7]",0)), ISNUMBER(INDIRECT("RC[-8]",0)), ISNUMBER(INDIRECT("RC[-9]",0))),TRUE)',
    },
  ],
  contents: [
    {
      range: [
        ...
        {
          values: [
            `="Tên dự án: "&UPPER('${DAU_VAO_OBJECT.name}'!${TEN_CONG_TRINH_RANGE})`,
          ],
          bold: true,
          vCenter: true,
          colSpan: [7],
        ...
        {
          values: [
            `="Tên công trình: "&'${DAU_VAO_OBJECT.name}'!${TEN_CONG_TRINH_RANGE}`,
          ],
          bold: true,
          vCenter: true,
          colSpan: [7],
        ...
        {
          values: [
            `="Hạng mục công trình: "&'${DAU_VAO_OBJECT.name}'!${TEN_CONG_TRINH_RANGE}`,
          ],
          bold: true,
          vCenter: true,
          colSpan: [7],
